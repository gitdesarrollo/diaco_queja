...
export class ConfiguracionService {
  ...
  saveConfUsuario (nit, usuario, nombre, dpi, estado, email, puesto, sede, telefono, glob_paramgen, valor_global_aprobarpp, valor_global_catalogos, id_usuario, valor_global_admusuarios, rolAtConCtrl, valor_atcon_admcolas, valor_atcon_presencial, rolJurCtrl, valor_jur_admcolas, rolVyVCtrl, valor_vyv_admcolas, rolSPCtrl,  valor_sp_admcolas, valor_global_configuracion, resetpassword, valor_atcon_call_center): Observable<any> {
	...
	saveConfiguracion (dias_expirar_atcon, dias_alerta_atcon, dias_link_verif_datos, dias_primera_audiencia , dias_segunda_audiencia ,  dias_expirar_jur, dias_alerta_jur, dias_expirar_vyv, dias_alerta_vyv, dias_expirar_sp, dias_alerta_sp, dias_expirar_pp, dias_link_int_conc_virt, dias_link_conf_queja_fin, correo_com_perm, correo_verif_datos, correo_audiencias, correo_arch_sp, correo_confrespp): Observable<any> {
		console.log(this.ObjaJSON_Configuracion(dias_expirar_atcon, dias_alerta_atcon, dias_link_verif_datos, dias_primera_audiencia , dias_segunda_audiencia , dias_expirar_jur, dias_alerta_jur, dias_expirar_vyv, dias_alerta_vyv, dias_expirar_sp, dias_alerta_sp, dias_expirar_pp, dias_link_int_conc_virt, dias_link_conf_queja_fin, correo_com_perm, correo_verif_datos, correo_audiencias, correo_arch_sp, correo_confrespp));
		var localURL=this.baseUrl+'/confgeneral';
		return this._http.post<any>(localURL, this.ObjaJSON_Configuracion(dias_expirar_atcon, dias_alerta_atcon, dias_link_verif_datos, dias_primera_audiencia , dias_segunda_audiencia,  dias_expirar_jur, dias_alerta_jur, dias_expirar_vyv, dias_alerta_vyv, dias_expirar_sp, dias_alerta_sp, dias_expirar_pp, dias_link_int_conc_virt, dias_link_conf_queja_fin, correo_com_perm, correo_verif_datos, correo_audiencias, correo_arch_sp, correo_confrespp), this.httpOptions).pipe(
			/*tap((item) => console.log('Added item')),
			catchError(this.handleError<any>('Add Data'))*/
			map(this.extractData)
		);
